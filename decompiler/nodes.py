...
from typing import Any, Dict, List, NamedTuple, Optional, Union, Tuple, Callable, Set
...
class Node(ABC):
    ...
    def remap_subflow(self, remap: Dict[Tuple[str, str], Tuple[str, str, List[RootNode.VarDef]]], visited: Optional[Set[Node]] = None) -> None:
        if visited is None:
            visited = set()
        visited.add(self)
